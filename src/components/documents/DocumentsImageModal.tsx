...
export const DocumentsImageModal = ({
                                        item,
                                        downloadLabel,
                                        closeLabel,
                                        onClose,
                                    }: DocumentsImageModalProps) => {
    useEffect(() => {
    ...
    return (
        <div
            className="fixed inset-0 z-[1000] flex items-start justify-center overflow-y-auto bg-black/78 px-3 pb-6 pt-[120px] backdrop-blur-md sm:px-6 sm:pt-[130px] lg:px-8 lg:pt-[130px]"
            role="dialog"
            aria-modal="true"
        >
            <button
