            ...
            <div className="relative z-10 mx-auto flex max-w-[92rem] flex-col gap-8 px-5 py-9 text-center md:px-8 lg:flex-row lg:items-center lg:justify-between lg:text-left">
                ...
                <div className="min-w-[300px] lg:text-right">
                    ...
                    <Link
                        ...
                        className="mt-4 inline-flex items-center justify-center rounded-full border border-[var(--sirko-bronze)] bg-[var(--sirko-bronze)] px-4 py-2 font-serif text-sm font-black uppercase tracking-[0.18em] text-[var(--sirko-wood-950)] shadow-[0_0_34px_rgba(196,147,54,0.28)] transition hover:border-[var(--sirko-gold-pale)] hover:bg-[var(--sirko-gold-pale)] hover:text-[var(--sirko-wood-950)]"
                    >
